...
export default function FileUploader({ onResult, onError }) {
  ...
  const { uploadDocument, retryExtraction, reconnectExtraction } =
    ...
    <div>
      <div
        ...
        className={classNames(
          ...
          "bg-background dark:bg-[#2f2f2f]",
          "border-border dark:border-[#4a4a4a]",
          {
      ...
      >
        ...
        <label htmlFor="file-input" className="cursor-pointer block">
          <div className="flex flex-col items-center">
            <svg
              className="w-12 h-12 text-muted-foreground dark:text-[#8e8e8e] mb-3"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        {file && !isProcessing && (
          <div className="mt-4 space-y-4">
            {/* File info */}
            <div className="p-3 bg-popover dark:bg-[#1a1a1a] rounded flex items-center justify-between border border-border dark:border-[#3f3f3f] transition-colors duration-200">
              <div>
                <div className="font-medium text-foreground dark:text-[#ececec]">
                  {file.name}
                </div>
                <div className="text-xs text-muted-foreground dark:text-[#a8a8a8]">
              ...
              <button
                ...
                className="text-muted-foreground dark:text-[#a8a8a8] hover:text-foreground dark:hover:text-[#ececec] transition-colors"
              >
                Remove
              </button>
            </div>
            ...
            <div className="p-4 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-[#1a1a2e] dark:via-[#1a2332] dark:to-[#1e1a2e] rounded-lg border border-purple-200 dark:border-[#3a3a5a]">
              <label className="block mb-2">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-sm font-medium text-foreground dark:text-[#ececec]">
                    💡 Add Context (Optional)
                  </span>
                </div>
                <div className="text-xs text-muted-foreground dark:text-[#a8a8a8] mb-3">
                  Guide the extraction by providing specific instructions or
                  focus areas
                </div>
              </label>
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 rounded border border-border dark:border-[#4a4a4a] bg-background dark:bg-[#2f2f2f] text-foreground dark:text-[#ececec] placeholder-gray-400 dark:placeholder-[#8e8e8e] focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent resize-none text-sm"
              />
              <div className="text-xs text-muted-foreground dark:text-[#a8a8a8] mt-1 text-right">
            ...
            <button
              ...
              className="w-full bg-blue-600 dark:bg-blue-600 text-foreground px-4 py-3 rounded-lg hover:bg-blue-700 dark:hover:bg-primary transition-colors font-medium"
            >
              Upload & Extract
            </button>
          </div>
