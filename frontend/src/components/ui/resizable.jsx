...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm border bg-border cursor-col-resize data-[panel-group-direction=vertical]:cursor-row-resize">
