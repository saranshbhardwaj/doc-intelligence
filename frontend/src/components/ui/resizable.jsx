...
const ResizableHandle = ({
  ...
  <Separator
    className={cn(
      ...
      withHandle && "pointer-events-none",
      className
    )}
    {...props}
  >
    {withHandle && (
      <div className="pointer-events-auto z-10 flex h-8 w-5 items-center justify-center rounded-sm border bg-muted hover:bg-accent transition-colors cursor-col-resize data-[panel-group-direction=vertical]:cursor-row-resize">
