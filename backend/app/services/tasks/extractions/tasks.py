...
from app.services.extractions.llm_service import ExtractionLLMService
...
def extract_structured_task(self, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        from app.services.extractions.prompts import CIM_EXTRACTION_SYSTEM_PROMPT, create_extraction_prompt
