...
class V1RagPromptSet(RagPromptSet):
    ...
    def comparison_system_instructions(self) -> str:
        return (
            ...
            "|--------|------------|------------|------------|\n"
            "| Cap Rate | 8.11% [S1:p6] | 6.50% [S2:p4] | +1.61% |\n\n"
            "TABLE FORMAT (3+ documents):\n"
            "| Metric | Document A | Document B | Document C |\n"
            "|--------|------------|------------|------------|\n"
            "| Cap Rate | 8.11% [S1:p6] | 6.50% [S2:p4] | 7.20% [S3:p9] |\n\n"
            "CITATION RULES:\n"
            "- Every number in the table must have a citation [Sn:pN] where n is the sequential source number shown above.\n"
