...
def _build_om_source_data(doc_results: list[ExtractedDocResult]) -> dict | None:
    for result in doc_results:
        ...
        data = {
            ...
            "property_tax_millage_rate": om.property_tax_millage_rate,
            "mil_rate": om.property_tax_millage_rate,
            "proposed_loan_amount": om.proposed_loan_amount,
            "proposed_down_payment_amount": om.proposed_down_payment_amount,
            "proposed_down_payment_pct": om.proposed_down_payment_pct,
