...
- `classification` MUST equal STRUCTURED DATA.classification verbatim (one of: "Pursue", "Needs Review", "Below Screen"). If the value would differ, return the STRUCTURED DATA value — the renderer will override anyway.
