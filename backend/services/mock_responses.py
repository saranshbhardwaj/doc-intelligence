# services/mock_responses.py
from datetime import datetime
import uuid
from typing import Dict

def get_mock_cim_response() -> Dict:
    """
    Enhanced mock CIM extraction response matching exact Pydantic models.
    Used for testing UI and development without hitting Claude API.
    """
    return {
        "data": {
            "company_info": {
            ...
            "extraction_notes": "Mock data for UI testing. All figures are fabricated examples designed to showcase PE analysis fields."
        },
        "metadata": {
